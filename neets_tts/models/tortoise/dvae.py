# Copied from DLAS lucidrains_dvae.py:
# https://git.ecker.tech/mrq/DL-Art-School/raw/branch/master/dlas/models/audio/tts/lucidrains_dvae.py
...
from neets_tts.models.tortoise.vqvae import Quantize
